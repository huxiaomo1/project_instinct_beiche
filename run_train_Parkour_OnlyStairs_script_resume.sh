...
CUDA_VISIBLE_DEVICES=1 nohup bash -c '
    ...
    exec python scripts/instinct_rl/train.py \
        ...
        --headless \
        --logroot=/data3/dhy/Train_and_Play/InstinctLab/logs/instinct_rl/g1_parkour_onlystairs \
        --resume \
        --load_run=/data3/dhy/Train_and_Play/InstinctLab/logs/instinct_rl/g1_parkour_onlystairs/20260902_104751 \
