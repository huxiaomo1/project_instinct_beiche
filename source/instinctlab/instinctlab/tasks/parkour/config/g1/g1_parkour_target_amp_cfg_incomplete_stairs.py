...
from instinctlab.tasks.parkour.config.parkour_env_cfg_incompletestairs import (
    PLAY_DUAL_PYRAMID_SPAWN_X,
    PLAY_DUAL_PYRAMID_SPEED,
    PLAY_DUAL_PYRAMID_TERRAINS_CFG,
    ROUGH_TERRAINS_CFG_INCOMPLETE_STAIRS,
    ParkourEnvCfg,
)
...
class AmassMotionCfg(AmassMotionCfgBase):
    ...
    terrain_motion_file_patterns = {
        ...
        "incomplete_pyramid_stairs": ["parkour_motion_without_run_retargetted.npz"],
        "incomplete_pyramid_stairs_high": ["parkour_motion_without_run_retargetted.npz"],
        "incomplete_pyramid_stairs_inv": ["parkour_motion_without_run_retargetted.npz"],
        "incomplete_pyramid_stairs_inv_high": ["parkour_motion_without_run_retargetted.npz"],
    ...
    terrain_motion_start_from_middle_range = {
        ...
        "incomplete_pyramid_stairs": (0.0, 0.9),
        "incomplete_pyramid_stairs_high": (0.0, 0.9),
        "incomplete_pyramid_stairs_inv": (0.0, 0.9),
        "incomplete_pyramid_stairs_inv_high": (0.0, 0.9),
...
ROUGH_TERRAINS_CFG_PLAY = copy.deepcopy(ROUGH_TERRAINS_CFG_INCOMPLETE_STAIRS)
