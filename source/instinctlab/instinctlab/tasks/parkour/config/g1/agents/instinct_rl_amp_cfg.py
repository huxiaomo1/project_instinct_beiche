...
@configclass
class G1IncompleteStairsPPORunnerCfg(G1ParkourPPORunnerCfg):
    """Runner configuration with an isolated log directory for incomplete stairs."""

    experiment_name = "g1_parkour_incomplete_stairs"
