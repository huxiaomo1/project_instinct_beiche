...
class EventCfg:
    ...
    randomize_camera_offset = EventTerm(
        ...
        mode="startup",  # 训练开始时随机化一次，或者用 "reset" 每个episode重置时随机化
        params={
            "asset_cfg": SceneEntityCfg("camera"),
            "offset_pose_ranges": {
                "x": (-0.001, 0.001),    # 米，相机x方向±1cm随机偏移
                "y": (-0.001, 0.001),  # 米，相机y方向±0.5cm随机偏移
                "z": (-0.001, 0.001),    # 米，相机z方向±1cm随机偏移
                "roll": (-2.0, 2.0),   # 度，roll随机偏转±5°
                "pitch": (-20.0, 20.0),  # 度，pitch随机偏转±20°
                "yaw": (-2.0, 2.0),  # 度，yaw随机偏转±5°（主要误差来源）
            },
